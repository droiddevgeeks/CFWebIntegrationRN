...
const WebsiteDefaultUpiPaymentScreen = ({}) => {
    ...
    return (React.createElement(WebView, { source: { uri: 'https://www.cashfree.com/devstudio/preview/pg/web/checkout#renderCheckout' }, style: { flex: 1 }, onShouldStartLoadWithRequest: event => {
